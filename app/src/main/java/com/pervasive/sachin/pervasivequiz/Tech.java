...
public class Tech extends Fragment {
    ...
    private TechQuestionLibrary mQuestionLibrary = new TechQuestionLibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if (mButtonChoice1.getText() == mAnswer){
                    ...
                    Toast.makeText(Tech.this.getActivity(), "correct", Toast.LENGTH_SHORT).show();

                }else {
                    mScore = mScore - 1;
                    updateScore(mScore);
                    Toast.makeText(Tech.this.getActivity(), "wrong", Toast.LENGTH_SHORT).show();
                    updateQuestion();
                }
            }
        });
    ...
    private void updateQuestion(){
        if (mQuestionNumber < 5) {
            ...
            args.putString("TECH_SCORE", String.valueOf(mScore));
